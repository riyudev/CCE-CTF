...
export default function LeaderboardRow({ teamData, userTeamName }) {
  ...
  return (
    <>
      {/* ---------------- DESKTOP TABLE ROW ---------------- */}
      <tr
        className={`hidden md:table-row transition-all duration-200 border-b border-[#242424]/60 ${
          isCurrentTeam
      ...
      {/* ---------------- MOBILE CARD VIEW ---------------- */}
      <div
        className={`md:hidden bg-[#111111] border p-4 rounded-sm space-y-3 transition-all ${
          isCurrentTeam
      ...
      >
        ...
        <div className="flex items-center justify-between pt-2 border-t border-[#242424]/60 text-xs font-spaceMonoBold">
          <div className="text-[#39FF14] font-minecraftBold text-sm">
            {score} PTS
          </div>
